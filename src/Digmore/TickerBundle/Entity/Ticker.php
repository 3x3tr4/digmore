 ...
 * Ticker
 *
 * @ORM\Table(name="ticker", indexes={@ORM\Index(name="pair_id", columns={"pair_id"})})
 * @ORM\Entity
 */
class Ticker
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="Digmore\TickerBundle\Entity\CurrencyPair", inversedBy="ticks")
     * @ORM\JoinColumns({
    ...
    public function getPairName()
    {
        ...
        $pair->readPair($this->getPair());

        return strtoupper(
            strreplace('_', '/', $pair->getName())
        );
    }
}
